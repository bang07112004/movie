      ...
      <div className="flex gap-2 items-center">
        ...
        >
          <Image
            ...
            height={200}
            alt="My avatar"
            className="md:rounded-full rounded-lg h-14 w-20 md:h-24 md:w-24 border-2 dark:border-black transition-all duration-500 border-gray-700 group-hover:border-amber-400"
          />
